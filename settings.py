...
settings = {
    ...
    # Options are [relu, sigmoid, tanh, linear, leaky_relu]
    ...
    # A list containing number of nodes in each hidden layer
    ...
    # Value must be between [0.00, 1.00)
    'mutation_rate':               0.05,
    ...
    # Values must be between [0.00, 1.00]
    ...
    # Options are 'r' for row or 'c' for column
    'SPBX_type':                   'r',
